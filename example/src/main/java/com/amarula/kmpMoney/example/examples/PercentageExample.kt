...
private const val VAT_RATE_PERCENT = 16
...
fun PercentageExample() {
    ...
    ExampleCard(title = "Percentage calculations") {
        ...
        CalculateButton {
            ...
            val withVat = subtotal.addPercentage(VAT_RATE_PERCENT)
            percentageResult = subtotal.percentage(VAT_RATE_PERCENT).toMoneyString()
            addPercentageResult = withVat.toMoneyString()
            subtractPercentageResult = withVat.subtractPercentage(VAT_RATE_PERCENT).toMoneyString()
        }
